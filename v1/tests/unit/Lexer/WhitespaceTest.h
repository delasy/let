/**
 * @created_at: 2019-07-06 12:39:29
 * @author: Aaron Delasy
 * @license_start
 *
...
#ifndef TESTS_LEXER_WHITESPACETEST_H
#define TESTS_LEXER_WHITESPACETEST_H

#include "../../../src/Lexer/Whitespace.h"

namespace let {
  TEST(LexerWhitespaceTest, SingleSpace) {
    ...
    ASSERT_TRUE(LexerWhitespace::is(&lexer, reader));
    EXPECT_EQ(lexer.token, LEXER_WS);
  ...
  TEST(LexerWhitespaceTest, SingleCarriageReturn) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
    ...
    ASSERT_TRUE(LexerWhitespace::is(&lexer, reader));
    EXPECT_EQ(lexer.token, LEXER_WS);
    EXPECT_EQ(lexer.rawValue, "\r");
    EXPECT_EQ(lexer.value, "\r");
    EXPECT_EQ(lexer.locationRange.start.charIdx, 1);
    EXPECT_EQ(lexer.locationRange.start.lineNum, 1);
    EXPECT_EQ(lexer.locationRange.end.charIdx, 2);
    EXPECT_EQ(lexer.locationRange.end.lineNum, 2);
  ...
  TEST(LexerWhitespaceTest, SingleNewLine) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
  ...
  TEST(LexerWhitespaceTest, SingleNewPage) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
    ...
    ASSERT_TRUE(LexerWhitespace::is(&lexer, reader));
    EXPECT_EQ(lexer.token, LEXER_WS);
    EXPECT_EQ(lexer.rawValue, "\f");
    EXPECT_EQ(lexer.value, "\f");
    EXPECT_EQ(lexer.locationRange.start.charIdx, 1);
    EXPECT_EQ(lexer.locationRange.start.lineNum, 1);
    EXPECT_EQ(lexer.locationRange.end.charIdx, 2);
    EXPECT_EQ(lexer.locationRange.end.lineNum, 2);
  ...
  TEST(LexerWhitespaceTest, SingleHorizontalTab) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
  ...
  TEST(LexerWhitespaceTest, SingleVerticalTab) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
    ...
    ASSERT_TRUE(LexerWhitespace::is(&lexer, reader));
    EXPECT_EQ(lexer.token, LEXER_WS);
    EXPECT_EQ(lexer.rawValue, "\v");
    EXPECT_EQ(lexer.value, "\v");
    EXPECT_EQ(lexer.locationRange.start.charIdx, 1);
    EXPECT_EQ(lexer.locationRange.start.lineNum, 1);
    EXPECT_EQ(lexer.locationRange.end.charIdx, 2);
    EXPECT_EQ(lexer.locationRange.end.lineNum, 2);
  ...
  TEST(LexerWhitespaceTest, SingleBackspace) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
    ...
    ASSERT_TRUE(LexerWhitespace::is(&lexer, reader));
    EXPECT_EQ(lexer.token, LEXER_WS);
    EXPECT_EQ(lexer.rawValue, "\b");
    EXPECT_EQ(lexer.value, "\b");
    EXPECT_EQ(lexer.locationRange.start.charIdx, 1);
    EXPECT_EQ(lexer.locationRange.start.lineNum, 1);
    EXPECT_EQ(lexer.locationRange.end.charIdx, 2);
    EXPECT_EQ(lexer.locationRange.end.lineNum, 2);
  ...
  TEST(LexerWhitespaceTest, SingleWithEOF) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
  ...
  TEST(LexerWhitespaceTest, Multiple) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
  ...
  TEST(LexerWhitespaceTest, Mismatch) {
    testing::StrictMock<LexerMock> lexer;
    testing::StrictMock<ReaderMock> reader;
    ...
    ASSERT_FALSE(LexerWhitespace::is(&lexer, reader));
